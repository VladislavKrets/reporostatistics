...
public class HttpMethodUtils {
    ...
    public static String getMethod(String urlPath, String api, String seconds, String sign){
        System.out.println(urlPath);
        try {
            if (urlPath == null) return null;
            HttpGet httpGet = new HttpGet(urlPath);
            httpGet.addHeader("accept", "application/json");
            httpGet.addHeader("x-reporo-epoch", seconds);
            httpGet.addHeader("x-reporo-key", api);
            httpGet.addHeader("x-reporo-mash", sign);
